    ...
    o.prototype = {
        init: function () {
            ...
            myhtml = e('<div class="syco_tooltip" data-tooltip="' + thisid + '" style="' + n + "padding:" + this.options.tooltipPadding + "px;top:" + firstoffset + "px;position:absolute;background:#" + 
            	this.options.tooltipBackgroundColor + ";" + this.options.tooltipPosition + ":-" + marginRight + "px;width:" + this.options.tooltipWidth + 'px" ><span class="triangle_' + this.options.tooltipPosition + '" style="' + s + '"></span><p style="' + $display2 + "font-size:" + 
            	this.options.tooltipFontSize + "px;color:#" + this.options.tooltipFontColor + '"><span class="tooltip_helper"><span data-index="1" ></span>' + "</span> " 
            	+ firsthelper + '</p><div class="percentagebar" style="' + $display + "background:#" + this.options.progressBarBackground + '""><div class="percentagebarinner" style="' + i + "background:#" + this.options.progressBarColor + '"></div><span class="percent" ' + $display + ">0%</span></div></div>");
            ...
            data_prog.each(function () {
                ...
                n.bind("live focus change", function () {
                    ...
                    thistooltip.find("p").html('<span class="tooltip_helper"><span data-index="1" >' + "</span>" + "</span> " + thishelper).parent().find(".percentagebarinner").css("width", parseInt(percentage) + "%").next().html(parseInt(percentage) + "%");
